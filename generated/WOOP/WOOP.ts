...
export class UnFreezed extends ethereum.Event {
  get params(): UnFreezed__Params {
    return new UnFreezed__Params(this);
  }
}

export class UnFreezed__Params {
  _event: UnFreezed;

  constructor(event: UnFreezed) {
    this._event = event;
  }
}

export class WOOP__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class WOOP extends ethereum.SmartContract {
  static bind(address: Address): WOOP {
    return new WOOP("WOOP", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): WOOP__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new WOOP__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<WOOP__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new WOOP__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
